...
public class AdaptadorAgregarNotas extends BaseAdapter {
    ...
    public View getView(int i, View convertView, ViewGroup parent) {
        ...
        TextView nota = (TextView) vista.findViewById(R.id.lista_nota);
        TextView porcentaje = (TextView) vista.findViewById(R.id.lista_porcentaje);
        ImageButton btnElminarNota = (ImageButton) vista.findViewById(R.id.btnEliminarNotas);

        nota.setText(itemNotas.get(0).get(i));
        porcentaje.setText(itemNotas.get(1).get(i));
